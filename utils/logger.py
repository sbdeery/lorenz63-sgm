...
class Logger:
    ...
    def __init__(self, log_dir: str | Path, csv_name: str = "training_log.csv") -> None:
        ...
        self.tb_writer = SummaryWriter(self.log_dir.as_posix()) if SummaryWriter else None
        self._init_csv()
    ...
    def log_metrics(self, epoch: int, metrics: Dict[str, float], split: str = "train") -> None:
